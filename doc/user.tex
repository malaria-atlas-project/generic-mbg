...
{\color{red}WARNING/2} in \texttt{../README.rst}, line~362
...
{\color{red}WARNING/2} in \texttt{../README.rst}, line~365
...
\item The name of a text file containing one or more multipolygons in geojson format. The
\end{list}
...
{\color{red}WARNING/2} in \texttt{../README.rst}, line~368
...
\texttt{properties} of each multipolygon must contain a unique \texttt{name} key. For
spatiotemporal models, they must also contain \texttt{tmin} and \texttt{tmax} keys.
