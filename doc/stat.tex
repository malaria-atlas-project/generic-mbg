...
\begin{description}
    ...
    \item[\texttt{nugget\_labels}] A dictionary mapping the \texttt{f\_labels} to the labels of their associated nugget variances, ie \texttt{\{'g\_x': 'V'\}}. Not used at keys where \texttt{fs\_have\_nugget} is false.
